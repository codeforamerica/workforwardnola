      ...
      def images
        [
          { trait: 'Following instructions',
            ...
            alt: 'Person is looking at a recipe on a computer before they begins chopping vegetables',
            file: 'instructions.jpg' },
          { trait: 'Working with your hands',
            reverse_trait: 'Technical',
            title: 'Working with your hands',
            alt: 'Person has a a screwdriver and wrench in their hands and is working on mechanical parts',
            file: 'withhands.jpg' },
          { trait: 'Teamwork',
          ...
          { trait: 'No fear of heights',
            ...
            alt: 'Person is working on powerlines several feet off the ground',
            file: 'heights.jpg' },
